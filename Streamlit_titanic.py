...
def cargar_datos(): #función para cargar los datos
    return pd.read_csv(r"C:\Users\lucia\Desktop\UPGRADE_works\Entrega_1\titanic.csv")
...
df = pd.read_csv(r"C:\Users\lucia\Desktop\UPGRADE_works\Entrega_1\titanic.csv")
...
if page == 'Inicio':
    ...
    # Ancho de las columnas laterales para centrar la imagen principal
    col1, col2, col3 = st.columns([1,6,1])
    with col2: # Imagen centrada
    ...
    # Difference in means for 'Survived' based on 'FirstClass'
        diff = group_df[group_df['FirstClass'] == 1]['Survived'].mean() - group_df[group_df['FirstClass'] == 0]['Survived'].mean()
    # Weight = the proportion of total observations that are in this group
